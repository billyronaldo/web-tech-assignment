...
const App = () => {
  ...
  return (
    <div>
      ...
      <main>
        {page === 'productList' && <ProductList addToCart={addToCart} setPage={setPage} setSelectedProduct={setSelectedProduct} />}
        {page === 'productDetail' && <ProductDetail product={selectedProduct} addToCart={addToCart} setPage={setPage} />}
